package com.yesandroid.sqlite.data;

import com.yesandroid.sqlite.data.movie.source.MoviesRepository;
import com.yesandroid.sqlite.data.movie.source.local.MovieCacheDataSource;
import com.yesandroid.sqlite.data.movie.source.local.MovieLocalDataSource;
import com.yesandroid.sqlite.data.movie.source.local.dao.MovieDao;
import com.yesandroid.sqlite.data.movie.source.local.database.MovieDatabase;
import com.yesandroid.sqlite.data.movie.source.remote.MovieRemoteDataSource;
import com.yesandroid.sqlite.data.movie.source.remote.services.MovieApi;
import com.yesandroid.sqlite.data.movie.source.remote.services.MovieService;
